 ...
 * Portfolio Title.
 */
function espied_portfolio_title( $before = '', $after = '' ) {
 ...
 * Portfolio Content.
 */
function espied_portfolio_content( $before = '', $after = '' ) {
 ...
 */
function espied_portfolio_thumbnail( $before = '', $after = '' ) {
 ...
 */
function espied_portfolio_infinite_scroll_navigation( $js_settings ) {
	if ( is_post_type_archive( 'jetpack-portfolio' ) || is_tax( 'jetpack-portfolio-type' ) || is_tax( 'jetpack-portfolio-tag' ) ) {
		$js_settings[ 'text' ] = esc_js( esc_html__( 'Older projects', 'espied' ) );
	}

	return $js_settings;
}
add_filter( 'infinite_scroll_js_settings', 'espied_portfolio_infinite_scroll_navigation' );
